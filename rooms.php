        ...
        <div class="row">
            ...
            while($room_data =mysqli_fetch_assoc($room_res))
            {
               ...
               while($fac_row = mysqli_fetch_assoc($fac_q)){
                ...
                $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' class='btn btn-sm w-100 text-white custom-bg shadow-none'>Book Now</a>";
            ...
            echo<<<data
                    ...
                    <div class="row g-0 p-3 align-items-center">
                        ...
                        <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                            <img src="images/Rooms/main.jpg" class="img-fluid rounded">
                        </div>
